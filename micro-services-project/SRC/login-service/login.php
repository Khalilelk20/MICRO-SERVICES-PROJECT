...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: http://<?php echo $publicIP; ?>/espace.php");
        exit();
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="http://<?php echo $publicIP; ?>/login.css">
            ...
            <div class="form login">
                ...
                <div class="login-signup">
                    <span class="text">Not a member?
                        <a href="http://<?php echo $publicIP; ?>/inscription.php" class="text signup-link">Signup Now</a>
                    </span>
                </div>
            </div>
        </div>
