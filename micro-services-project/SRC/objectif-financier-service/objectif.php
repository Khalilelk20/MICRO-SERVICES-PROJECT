...
<head>
    ...
    <link rel="stylesheet" href="http://<?php echo $publicIP; ?>/objectifs_financiers.css">
</head>
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="http://<?php echo $publicIP; ?>/">Accueil</a></li>
                <li><a href="http://<?php echo $publicIP; ?>/espace.php">Espace Personnel</a></li>
                <li><a href="http://<?php echo $publicIP; ?>/objectif.php">Objectifs Financiers</a></li>
                <li><a href="http://<?php echo $publicIP; ?>/alertes.php">Alertes</a></li>
                <li><a href="http://<?php echo $publicIP; ?>/transaction.php">Transactions</a></li>
                <li><a href="http://<?php echo $publicIP; ?>/logout.php">Déconnexion</a></li>
            </ul>
        </nav>
    </header>
    <div class="container">
