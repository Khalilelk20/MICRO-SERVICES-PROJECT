#!/bin/bash
services=("front-service" "db-service" "redis-service" "espace-perso-service" "inscription-service" "login-service" "logout-service" "objectif-financier-service" "transaction-service" "alertes-service")
